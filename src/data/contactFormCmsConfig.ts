...
export const mergeWithContactFormCMS = (cmsContent?: Partial<ContactFormContent>): ContactFormContent => {
  return {
    ...
    formFields: {
      ...
      ...(cmsContent?.formFields && {
        name: { ...defaultContactFormContent.formFields.name, ...cmsContent.formFields.name },
        email: { ...defaultContactFormContent.formFields.email, ...cmsContent.formFields.email },
        state: { ...defaultContactFormContent.formFields.state, ...cmsContent.formFields.state },
        comment: { ...defaultContactFormContent.formFields.comment, ...cmsContent.formFields.comment }
      })
    },
    submitButton: {
...
export const builderIOContactFormSchema = {
  ...
  fields: [
      ...
      subFields: [
        {
          ...
          subFields: [
            ...
            { name: 'errorRequired', type: 'string', defaultValue: 'Name is required' }
          ]
        },
        {
          name: 'email',
          ...
          subFields: [
            ...
            { name: 'placeholder', type: 'string', defaultValue: 'e.g. john@gmail.com' },
            { name: 'errorRequired', type: 'string', defaultValue: 'Email is required' },
            { name: 'errorInvalid', type: 'string', defaultValue: 'Please enter a valid email address' }
          ]
        },
        {
          name: 'state',
          ...
          subFields: [
            ...
            { name: 'placeholder', type: 'string', defaultValue: 'Select a state' },
            { name: 'errorRequired', type: 'string', defaultValue: 'Please select a state' }
          ]
        },
        {
          name: 'comment',
          ...
          subFields: [
            ...
            { name: 'placeholder', type: 'string', defaultValue: 'Please share your message or inquiry...' },
    ...
    },
    {
      ...
      type: 'object',
      subFields: [
        { name: 'title', type: 'string', defaultValue: 'Message Sent Successfully!' },
        { name: 'message', type: 'string', defaultValue: 'Thank you for contacting us. We\'ll get back to you soon.' },
        { name: 'buttonText', type: 'string', defaultValue: 'Send Another Message' }
      ]
    }
  ]
}
